...
public class DateUtils {
	 ...
	 * 
	 * @param date
	 *            "yyyyMMdd" format 유형의 Date String
	 * @param amount
	 *            더할 날짜 수
	 ...
	 *            더할 날짜 수
	 * @param format
	 *            날짜의 format 형식 ex> "yyyyMMdd" 또는 "yyyy/MM/dd"
	 ...
	 * @throws java.text.ParseException
	 */
	public static String addMinutes(String s, int minute, String format) throws java.text.ParseException {
		java.text.SimpleDateFormat formatter = new java.text.SimpleDateFormat(format, java.util.Locale.KOREA);
		java.util.Date date = check(s, format);
	 ...
	 * @throws java.text.ParseException
	 */
	public static long compareTime(String curDate, String compareDate, String format) throws java.text.ParseException {
	 ...
	 * @throws java.text.ParseException
	 */
	public static int daysBetween1(String from, String to) throws java.text.ParseException {
	 ...
	 * @throws java.text.ParseException
	 */
	public static int monthBetween(String from, String to) throws java.text.ParseException {
		Calendar cal = Calendar.getInstance();
		int nTotalDate1 = 0, nTotalDate2 = 0, nDiffOfYear = 0, nDiffOfDay = 0;
		int nYear1 = new Integer(to.substring(0, 4));
		int nYear2 = new Integer(from.substring(0, 4));
	...
	/**
	 * 메일 발송시 Date : 태그에 찍을 내용을 만든다. 예) "Mon, 7 Apr 2003 13:27:19 +0900" 와 같이
	 * 넘어온다.
	 * 
	 * @return
	 */
	 ...
	 * @throws java.text.ParseException
	 */
	public static int hoursBetween(String from, String to, String format) throws java.text.ParseException {
		java.util.Date d1 = check(from, format);
		java.util.Date d2 = check(to, format);
		long duration = d2.getTime() - d1.getTime();
	...
	public static String lastDayOfMonth(String src, String format) throws java.text.ParseException {
		...
		String tempDate = formatter.format(inputDateFormat.parse(String.valueOf(fourDf.format(year)) + String.valueOf(twoDf.format(month)) + String.valueOf(twoDf.format(day))));
	 ...
	 * @throws java.text.ParseException
	 */
	public static int minutesBetween(String from, String to, String format) throws java.text.ParseException {
		java.util.Date d1 = check(from, format);
		java.util.Date d2 = check(to, format);
		long duration = d2.getTime() - d1.getTime();
	 ...
	 * @throws java.text.ParseException
	 */
	public static int secondsBetween(String from, String to, String format) throws java.text.ParseException {
		java.util.Date d1 = check(from, format);
		java.util.Date d2 = check(to, format);
		long duration = d2.getTime() - d1.getTime();
	 ...
	 * @throws java.text.ParseException
	 */
	public static long millisecondsBetween(String from, String to, String format) throws java.text.ParseException {
		java.util.Date d1 = check(from, format);
		java.util.Date d2 = check(to, format);
		long duration = d2.getTime() - d1.getTime();
		return duration;
	 ...
	 * @throws java.text.ParseException
	 */
	public static String[] splitDate(String startDate, String endDate, int minute) throws java.text.ParseException {
	...
	/**
	 * "yyyyMMdd'형식의 주어진 날짜의 요일을 구한다. 1: 일요일 (java.util.Calendar.SUNDAY 와 비교) 2:
	 * 월요일 (java.util.Calendar.MONDAY 와 비교) 3: 화요일 (java.util.Calendar.TUESDAY 와
	 * 비교) 4: 수요일 (java.util.Calendar.WENDESDAY 와 비교) 5: 목요일
	 * (java.util.Calendar.THURSDAY 와 비교) 6: 금요일 (java.util.Calendar.FRIDAY 와
	 * 비교) 7: 토요일 (java.util.Calendar.SATURDAY 와 비교) 예) String s = "20000529";
	 * int dayOfWeek = whichDay(s, format); if (dayOfWeek ==
	 * java.util.Calendar.MONDAY) System.out.println(" 월요일: " + dayOfWeek); if
	 * (dayOfWeek == java.util.Calendar.TUESDAY) System.out.println(" 화요일: " +
	 * dayOfWeek);
	 * 
	 * @param s
	 *            날짜
	...
	/**
	 * 특정 형식의 주어진 날짜의 요일을 구한다. 1: 일요일 (java.util.Calendar.SUNDAY 와 비교) 2: 월요일
	 * (java.util.Calendar.MONDAY 와 비교) 3: 화요일 (java.util.Calendar.TUESDAY 와 비교)
	 * 4: 수요일 (java.util.Calendar.WENDESDAY 와 비교) 5: 목요일
	 * (java.util.Calendar.THURSDAY 와 비교) 6: 금요일 (java.util.Calendar.FRIDAY 와
	 * 비교) 7: 토요일 (java.util.Calendar.SATURDAY 와 비교) 예) String s = "20000529";
	 * int dayOfWeek = whichDay(s, format); if (dayOfWeek ==
	 * java.util.Calendar.MONDAY) System.out.println(" 월요일: " + dayOfWeek); if
	...
	/**
	 * <p>
	 * fromStr에서 toStr까지의 특정요일의 날짜만을 리턴한다.
	 * 
	 * @param fromStr
	 * @param toStr
	 * @return
	...
	/**
	 * <p>
	 * fromStr에서 toStr까지의 특정날짜의 날들을 리턴한다.
	 * 
	 * @param fromStr
	 * @param toStr
	 * @param dd
	...
	/**
	 * <p>
	 * 주어진 날짜에 주어진 일을 더한 날짜를 yyyy-MM-dd hh:mm:ss 형식으로 리턴
	 * 
	 * @param dateStr
	 * @param days
	 * @return
	...
	/**
	 * <p>
	 * 주어진 날짜에 주어진 월을 더한 날짜를 yyyy-MM-dd HH:mm:ss 형식으로 리턴
	 * 
	 * @param dateStr
	 * @param months
	 * @return
	...
	/**
	 * <p>
	 * 현재 날짜에 주어진 월을 더한 날짜를 yyyyMM 형식으로 리턴
	 * 
	 * @param months
	 * @return
	 * @throws Exception
	 *             임영호 추가
	 */
	public static String getDateAddYearMonths(int months) {
		String result = "";
	...
	/**
	 * <p>
	 * 현재 날짜에 주어진 일을 더한 날짜를 yyyy-MM-dd형식으로 리턴
	 * 
	 * @param dateStr
	 * @param days
	 * @return
	...
	/**
	 * <p>
	 * 현재 날짜에서 주어진 요일의 날짜를 구한다. 만약 오늘날짜보다 같거나 작다면 다음주의 날짜가 출력된다.
	 * 
	 * @param dd
	 * @return
	 */
	...
	/**
	 * <p>
	 * 현재 날짜에서 주어진 날의 날짜를 구한다. 만약 오늘날짜보다 같거나 작다면 다음달의 날짜가 출력된다.
	 * 
	 * @param dd
	 * @return
	 */
	...
	/**
	 * <p>
	 * mysql등에서 .0이 붙어 나오므로 정확히 19자리만(yyyy-MM-dd HH:mm:ss) 가져온다.
	 * 
	 * @param date
	 * @return
	 */
	...
	/**
	 * <p>
	 * 주어진 시작날짜(yyyyMM)에서 끝난날짜(yyyyMM)사이에 월 출력
	 * 
	 * @param fromStr
	 * @param toStr
	 * @return
	...
	/**
	 * <p>
	 * 날짜를 yyyy-mm-dd HH:mm:ss 형태로 출력한다.
	 * 
	 * @param dateStr
	 * @return
	 */
	...
	/**
	 * <p>
	 * yyyy-mm-dd 형태의 날짜와 오늘 날짜 비교
	 * 
	 * @param dateStr
	 *            ( yyyy-mm-dd )
	 * @return 오늘날짜 이전 false
	 * @return 오늘날짜 이후 true
	 */
	public static boolean toDayBetweenDateStr(String dateStr) {
		int year = Integer.parseInt(dateStr.substring(0, 4));
		int month = Integer.parseInt(dateStr.substring(5, 7));
		int day = Integer.parseInt(dateStr.substring(8, 10));
		// 비교하고자 하는 임의의 날짜
		Calendar aDate = Calendar.getInstance();
		aDate.set(year, month - 1, day); // month는 0부터 시작하기 때문에 -1
		...
		if (aDate.after(bDate)) {
			return true; // 오늘날짜 이후 true
		} else {
			return false; // 오늘날짜 이전 false
		}
	}
	
	/**
	 * 숫자로 넘어온 값(월,일)을 주어진 형태로 변환하여 넘주준다 
	 * Ex) 1 => 01 
	 * @param date
	 * @param format
	 * @return
	 */
	public static String changeFormat(int date, String format) {
